"""
Django settings for ftsa_40060 project.
...
WSGI_APPLICATION = 'ftsa_40060.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ftsa_40060 API",
    "DESCRIPTION": "API documentation for ftsa_40060 App",
    "VERSION": "v1",
}
